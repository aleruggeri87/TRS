...
#define  SOLUS_P_USE_TRIM_FILE            39      /* control type: binary, callback function: Setting */
#define  SOLUS_P_PRODUCE_TRIM_FILE        40      /* control type: binary, callback function: Setting */
