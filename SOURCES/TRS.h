...
#define  SOLUS_P_SAVE_DUMP                38      /* control type: binary, callback function: Setting */
#define  SOLUS_P_ADD_TEMP_IN_MEAS         39      /* control type: binary, callback function: Setting */
#define  SOLUS_P_INTERLOCK_BYP            40      /* control type: binary, callback function: Setting */
#define  SOLUS_P_USE_LEGACY_SEQ           41      /* control type: binary, callback function: Setting */
#define  SOLUS_P_USE_TRIM_FILE            42      /* control type: binary, callback function: Setting */
#define  SOLUS_P_PRODUCE_TRIM_FILE        43      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG6                    44      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG7                    45      /* control type: ring, callback function: Setting */
#define  SOLUS_P_AUTOCAL                  46      /* control type: binary, callback function: Setting */
#define  SOLUS_P_POWER_OPTODE_1           47      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_2           48      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_3           49      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_4           50      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_8           51      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_7           52      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_6           53      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_5           54      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_LASER_FREQ               55      /* control type: numeric, callback function: (none) */
#define  SOLUS_P_START_PIXEL              56      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_STOP_PIXEL               57      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_1            58      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_2            59      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_3            60      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_4            61      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_5            62      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_6            63      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_7            64      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_8            65      /* control type: numeric, callback function: Setting */
